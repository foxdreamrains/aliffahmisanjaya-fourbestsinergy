                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $f->user->npwp }}</td>
                                            <td>
                                                <a href="{{ route('cmsuserEdit', $f->id_file) }}" type="button" class="btn btn-info btn-sm">Edit</a> |
                                                <a href="{{ route('cmsuserDelete', $f->id_file) }}" type="button" class="btn btn-danger btn-sm">Delete</a>
                                            </td>
