...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-dark" style="background: #2a3c8e;">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
        <li class="nav-item">
...
<footer class="main-footer">
  <strong>Copyright &copy; {{ date('Y') }} <a href="" style="color: #302149;">PT FOUR BEST SINERGY</a></strong>
</footer>
</div>
<!-- ./wrapper -->
